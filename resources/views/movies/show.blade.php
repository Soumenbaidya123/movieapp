...
@section('content')
    <div class="movie-info border-b border-gray-800">
         <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
             ...
             @else
                 <img src="https://via.placeholder.com/384x578" alt="poster" class="w-64 lg:w-96">
             @endif
             <div class="md:ml-24">
...
{{--                                 href="https://youtube.com/watch?v="--}}
                                 class="flex inline-flex items-center bg-yellow-600
                                 text-gray-900 rounded font-semibold px-5 py-4
                                 hover:bg-yellow-700 transition ease-in-out
