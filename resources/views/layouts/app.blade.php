...
<head>
    ...
    <!-- Fonts -->
   <link href="htt ps://fonts.googleapis.com/css2?family=Nunito:wght@400;600;700&display=swap" rel="stylesheet">
        ...
        <div class="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 py-6">
            ...
            <div class="flex flex-col md:flex-row items-center">
                ...
                <div class="md:ml-4 mt-3 md:mt-0">
                    <a href="#">
                        <img class="rounded-full w-8 h-8" src="https://i.pravatar.cc/300?u=Alex@movieflix.com" alt="avatar">
                    </a>
                </div>
            </div>
        </div>
